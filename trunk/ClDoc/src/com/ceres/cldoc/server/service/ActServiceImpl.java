...
public class ActServiceImpl extends RemoteServiceServlet implements
	...
	@Override
	public List<Act> findByEntity(Session session, String className, Entity entity, Long roleId, Date dateFrom, Date dateTo) {
...
//		}
	...
	@Override
	public List<Act> save(Session session, List<Act> acts) {
